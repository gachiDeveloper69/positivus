export function setSlider (slider, slides) {
  ...
  window.addEventListener('resize', getSlideCenterDistance, centerClosestSlide(slider, slides, 0)); //Оптимизация при ресайзе
}
